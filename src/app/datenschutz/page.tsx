  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <h1 className="text-3xl font-bold text-[#1A1A1A] mb-8">Datenschutzerklärung</h1>
        
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#1A1A1A] mb-4">1. Datenschutz auf einen Blick</h2>
            
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Allgemeine Hinweise</h3>
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Datenerfassung auf dieser Website</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Wofür nutzen wir Ihre Daten?</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Welche Rechte haben Sie bezüglich Ihrer Daten?</h3>
            <div className="space-y-2 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#1A1A1A] mb-4">2. Hosting</h2>
            <div className="space-y-2 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#1A1A1A] mb-4">3. Allgemeine Hinweise und Pflichtinformationen</h2>
            
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Datenschutz</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Hinweis zur verantwortlichen Stelle</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Speicherdauer</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Hinweis zur Datenweitergabe in die USA und sonstige Drittstaaten</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Beschwerderecht bei der zuständigen Aufsichtsbehörde</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Recht auf Datenübertragbarkeit</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">SSL- bzw. TLS-Verschlüsselung</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Auskunft, Löschung und Berichtigung</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Recht auf Einschränkung der Verarbeitung</h3>
            <div className="space-y-2 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#1A1A1A] mb-4">4. Datenerfassung auf dieser Website</h2>
            
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Server-Log-Dateien</h3>
            <div className="space-y-2 text-gray-700">
            ...
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3 mt-6">Kontaktformular</h3>
            <div className="space-y-2 text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-[#1A1A1A] mb-4">5. Plugins und Tools</h2>
            
            <h3 className="text-lg font-semibold text-[#1A1A1A] mb-3">Google Fonts (lokales Hosting)</h3>
            <div className="space-y-2 text-gray-700">
